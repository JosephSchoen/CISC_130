...
{   /** Solution for part 1 **/
    ...
    int g; // Adding one additional variable to allow for swapping of variables if they are in a specific order
    g = c;
    ...
    printf("After first swap, a is %i, b is %i, and c is %i\n\n", a, b, c);

    a = c;
    c = b;
    b = g;

    printf("After second swap, a is %i, b is %i, and c is %i\n\n", a, b, c);
    ...
    bill_total = 57.34; //Any bill amount can be replaced in this to calculate different totals
